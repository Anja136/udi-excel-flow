...
// Helper function to determine default SRV status and downloadability based on device status
const getDefaultSrvStatusAndDownloadable = (status: string): { srvStatus: SrvStatus, isDownloadable: boolean } => {
  switch (status) {
    case 'Submitted':
      return { srvStatus: 'completed', isDownloadable: true };
    case 'Processed':
      return { srvStatus: 'in progress', isDownloadable: false };
    case 'Created':
      return { srvStatus: 'started', isDownloadable: false };
    case 'Needs Update':
    default:
      return { srvStatus: 'none', isDownloadable: false };
  }
};
...
export const mockDeviceData: DeviceDataWithAgencies[] = [
  // GUDID Devices (28 total: Created=4, Processed=8, Submitted=12, Needs Update=4)
  {
    ...
    ...getDefaultSrvStatusAndDownloadable("Submitted")
  },
  {
    id: "UDI-DI-00002",
    ...
    ...getDefaultSrvStatusAndDownloadable("Processed")
  },
  {
    id: "UDI-DI-00009",
    ...
    ...getDefaultSrvStatusAndDownloadable("Created")
  },
  {
    id: "UDI-DI-00011",
  ...
  },
  {
    ...
    ...getDefaultSrvStatusAndDownloadable("Needs Update")
  },
  {
    id: "UDI-DI-00014",
